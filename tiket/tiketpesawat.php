...
session_start();
$asal = $_SESSION['flightdari'];
$tujuan = $_SESSION['flightke'];
$tanggal = $_SESSION['flighttanggal'];
            ...
            <div class="row align-items-center h-500">
                <div class="col-7 mx-auto p-5">
                    ...
                    <div class="card-title font-weight-bold text-primary text-center">
                        <h1>Flight Ticket Preview</h1>
                    </div>

                    <br>

                    <form action="proses/tiketpesawat_proses.php" method="post">
                        ...
                        <div class="card-text text-dark text-center">
                            ...
                            <p class="h5">Booking Code: <b><?= $_SESSION['idbookingflight'] = kodebooking(); ?></b></p>
                        </div>
                        <br><br>
