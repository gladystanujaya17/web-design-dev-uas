                    ...
                    <div class="pull-right">
                        <div class="btn-group">                 
                                ...
                                <ul class="dropdown-menu">
                                  <li><a href="#" class="nav-link link-secondary icon">User Profile</a></li>
                                  <li><a href="#" class="nav-link link-secondary icon">Log Out</a></li>
                                </ul>
                            </div>
                    </div>
...
<!--                     <li class="nav-item pr-3">
                        <a href="../loginsignupphp/login.php" type="button" class="btn btn-outline-primary">
                            Login
                        </a>
                    </li>
                    <li class="nav-item pr-3">
                        <a href="../loginsignupphp/signup.php" type="button" class="btn btn-primary">
                            Signup
                        </a>
                    </li> -->
            </div>
