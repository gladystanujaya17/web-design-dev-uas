                ...
                <div class="card fat my-login-page">
                    <div class="card-body">
                        ...
                        $query = "SELECT avt.train_id, avt.train_departure, avt.train_arrival, cs.class_name, avt.train_price
                                ...
                                WHERE avt.train_departure LIKE ? AND avt.train_arrival LIKE ?
                                AND cs.class_name = ?";
                            ...
                            <div class=" card col-sm-12 search-result-list shadow p-1 mb-5 bg-white rounded">
                                <div class="card-body">
                                    <div class="card-title text-muted">
                                        <div class="row">
                                            <div class="container col-xs-10 col-sm-6 col-md-4"> <h2><?=$row['train_departure']?></h2>
                                            </div>
                                             <div class="container col-xs-10 col-sm-6 col-md-4">
                                            <i class="fas fa-train fa-3x text-primary"></i>
                                            </div>
                                            <div class="container col-xs-10 col-sm-6 col-md-4"><h2><?=$row['train_arrival']?></h2>
                                            </div>
                                        </div>
                                    </div>
                                <div class="card-text text-right">
                                <p class="font-weight-bold"><?=$row['class_name']?></p>
                                <p class="text-muted font-wegiht-bold"><?=number_format($row['train_price'])?></p>
                                <a href="../confirmation_train.php?id=<?=urlencode(base64_encode($row['train_id']))?>
                        ...
                        <?php    }
                            ...
                            echo "Kereta yang anda cari sedang tidak tersedia";
                        }
                        ?>
